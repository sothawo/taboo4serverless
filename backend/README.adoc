...
[source,shell]
----
curl -X "POST" "https://hom0160ulj.execute-api.eu-central-1.amazonaws.com/dev/bookmark" \
     -H 'x-api-key: EjOp1Yag551q6hQuA8QEA5e8A7k6ZkwJ9Wl8EUSO' \
...
[source,shell]
----
http --json POST 'https://hom0160ulj.execute-api.eu-central-1.amazonaws.com/dev/bookmark' \
    'x-api-key':'EjOp1Yag551q6hQuA8QEA5e8A7k6ZkwJ9Wl8EUSO' \
