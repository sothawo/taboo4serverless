...
[source,shell]
----
$ DYNAMODB_URL=http://localhost:4569 sls invoke local -f createTable
----
...
[source,shell]
----
$ DYNAMODB_URL=http://localhost:4569 sls invoke local -f deleteTable
----
...
[source,shell]
----
$ DYNAMODB_URL=http://localhost:4569 sls invoke local -f postBookmark -p testdata/postBookmarkEvent.json
----
...
[source,shell]
----
$ aws dynamodb scan --table-name taboo4-dev --endpoint=http://localhost:4569
----
...
[source,shell]
----
$ DYNAMODB_URL=http://localhost:4569 sam local start-api --docker-network taboo4 [--skip-pull-image]
----
